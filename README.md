...
All of these analysis and the concluded results has been done through R programming language and the codes and outputs are published through html-format which you may find [here](https://furkandanisman.github.io/Research_Supermarket_Sales/Code-and-output/Supermarket-code-output.html).
